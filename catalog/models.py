...
class Genre(models.Model):
    ...
    name = models.CharField(max_length=200,
                            help_text="Enter a book genre (e.g, Science "
                                      "Fiction, French Poetry, etc.)")

    def __str__(self):
        '''
        String for representing the Model object (on Admin site etc.)
        :return:
        '''
        return self.name
...
class Language(models.Model):
    '''
    Model representing the language that the a book was published in
    '''
    language = models.CharField(max_length=200, help_text="The language that "
                                                        "the "
...
class BookInstance(models.Model):
    '''
    Model representing a specific copy of a book (i.e., one that can be
